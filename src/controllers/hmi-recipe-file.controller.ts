  ...
  createCsvFile(): Promise<any> {
    ...
    return new Promise(async (resolve, reject): Promise<any> => {
      ...
      try {
        ...
        recipes.push('Common Recipe;V2;RecipeGroup1;NormalRecipe;0;Conditional;Vijeo-Designer 6.2.6');
        recipes.push('\n');
